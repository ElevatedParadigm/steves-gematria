...
- **Pattern Density**: High correlation with `124` Universal Bridge (0.0.96)
...
- `124` (Other symbol): Strength = 0.960
- `666` (Other symbol): Strength = 0.940
