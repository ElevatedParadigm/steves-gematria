...
- **Pattern Density**: High correlation with `124` Universal Bridge (0.0.89)
...
- `124` (Other symbol): Strength = 0.890
- `55` (Other symbol): Strength = 0.880
