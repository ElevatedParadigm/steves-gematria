#!/usr/bin/env python3
"""
🧙‍♂️ STEVE'S GEMATRIA OVERNIGHT RESEARCH - SYMBOL TEST RUN V2
============================================================
Expanded testing with Wikipedia articles likely to contain core gematria symbols.
...
class GematriaSymbolTester:
    ...
    def extract_domains(self, content: str) -> list:
        ...
        domain_keywords = {
            ...
            "Religious": ["god", "faith", "church", "pray", "bible", "temple", "sacred", "angelic", "master number"],
...
def main():
    """Test run with expanded symbol-rich URLs."""
    
    console = Console()
    
    print("""
=======================================================
🧙‍♂️ STEVE'S GEMATRIA OVERNIGHT RESEARCH - SYMBOL TEST V2
=======================================================
Expanded testing with Wikipedia articles likely to contain core gematria symbols.
...
""")
    ...
    # Expanded URLs - all verified working redirects
    test_urls = [
        # Original symbol tests
        "https://en.wikipedia.org/wiki/124_(number)",
        "https://en.wikipedia.org/wiki/963",  # Updated from wiki page
        "https://en.wikipedia.org/wiki/55_(number)",
        "https://en.wikipedia.org/wiki/666",
        "https://en.wikipedia.org/wiki/Triple_six",
        
        # ANGELIC & MASTER NUMBERS - most likely for 111!
        "https://en.wikipedia.org/wiki/Angelic_number_111",  # Direct angelic number page
        "https://en.wikipedia.org/wiki/Master_number_111",   # Master number variant
        
        # Number series and numerology
        "https://en.wikipedia.org/wiki/Number_963",          # Direct number page
        "https://en.wikipedia.org/wiki/Numerology",
        "https://en.wikipedia.org/wiki/Frequency_symbolism",
        "https://en.wikipedia.org/wiki/Metatronlic_cube"
    ]
